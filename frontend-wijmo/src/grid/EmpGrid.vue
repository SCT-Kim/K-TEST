<template>
    <div style="max-height:80vh;">
        ...
        <EmpViewQuery @search="search"></EmpViewQuery>
        ...
        >
            <wj-flex-grid-filter :filterColumns="['userId','rankId','deptId','empUser',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="empUser[0].name" header="empUser" width="2*" :isReadOnly="true" align="center" />
            ...
            <wj-flex-grid-column binding="deptId.name" header="dept" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <EmpUserDetailGrid :selectedGrid="selectedGrid" />
...
<script>
import EmpViewQuery from '../components/EmpViewQuery.vue';
import Emp from '../components/Emp.vue'
import EmpUserDetailGrid from './EmpUserDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.empUser;
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.emp.href;
